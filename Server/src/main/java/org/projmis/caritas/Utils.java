...
public class Utils {
	...
	public static void logProcessor(String place, String... message) {
		try {
			PrintWriter writer = new PrintWriter(new FileOutputStream(new File("caritas-log-processor.txt"), true));
	...
	public static void log(String place, String... message) {
		try {
			PrintWriter writer = new PrintWriter(new FileOutputStream(new File("caritas-log.txt"), true));
			writer.append("" + new Date() + "\t" + place);
			for (int i = 0; i < message.length; i++) {
				writer.append("\t" + message[i]);
			}
	...
	public static void saveException(String local, Exception exception) {
		...
		synchronized (object) {
			try {
				PrintWriter writer = new PrintWriter(new FileOutputStream(new File("caritas-exceptions.txt"), true));
